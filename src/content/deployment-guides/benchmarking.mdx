---
title: "Benchmarking"
metaTitle: "Benchmarking"
metaDescription: "Instructions for benchmarking"
index: 1000
---
...
Use of the DeepSparse Benchmarking utilities requires installation of the [DeepSparse Community](/installation-guides/product-suite-installation/deepsparse).
...
**TIP:** Save your benchmark results in a convenient JSON file.
...
- Synchronous (single-stream)
- Asynchronous (multi-stream)
...
### Example Benchmarking Output of Synchronous Versus Asynchronous

**BERT 3-layer FP32 Sparse Throughput** There is no need to add a scenario argument since async is the default option:
...
**BERT 3-layer FP32 Sparse Latency** To select a synchronous inference scenario, add -s sync:
