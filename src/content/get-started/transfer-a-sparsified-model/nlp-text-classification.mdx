...
- `model_name_or_path` - Starting model. It can be a SparseZoo stub, HF model identifier, or a local directory
...
- `task_name` - Sentiment analysis task. If not provided, this also specifies the dataset, pipelines, and evaluation metrics.
